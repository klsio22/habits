...
INSERT INTO
    "new_day_habits" ("day_id", "habit_id", "id")
SELECT
    "day_id",
    "habit_id",
    "id"
...
ALTER TABLE
    "new_day_habits" RENAME TO "day_habits";
...
INSERT INTO
    "new_habit_week_days" ("habit_id", "id", "week_day")
SELECT
    "habit_id",
    "id",
    "week_day"
...
ALTER TABLE
    "new_habit_week_days" RENAME TO "habit_week_days";
